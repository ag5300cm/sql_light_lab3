...
try:
    ...
    print("OperationalError: no such column: my_3rd_column")
...
#if we use the .fetchall() method, we return a list of tuples from the database query,
# where each tuple represents one row entry.
